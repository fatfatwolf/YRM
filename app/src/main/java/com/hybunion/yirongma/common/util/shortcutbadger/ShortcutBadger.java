...
import com.hybunion.yirongma.common.util.shortcutbadger.impl.AdwHomeBadger;
import com.hybunion.yirongma.common.util.shortcutbadger.impl.ApexHomeBadger;
import com.hybunion.yirongma.common.util.shortcutbadger.impl.AsusHomeLauncher;
import com.hybunion.yirongma.common.util.shortcutbadger.impl.DefaultBadger;
import com.hybunion.yirongma.common.util.shortcutbadger.impl.HuaweiHomeBadger;
import com.hybunion.yirongma.common.util.shortcutbadger.impl.NewHtcHomeBadger;
import com.hybunion.yirongma.common.util.shortcutbadger.impl.NovaHomeBadger;
import com.hybunion.yirongma.common.util.shortcutbadger.impl.SamsungHomeBadger;
import com.hybunion.yirongma.common.util.shortcutbadger.impl.SonyHomeBadger;
import com.hybunion.yirongma.common.util.shortcutbadger.impl.XiaomiHomeBadger;
import com.hybunion.yirongma.common.util.shortcutbadger.impl.ZukHomeBadger;
...
public final class ShortcutBadger {
    ...
    static {
        ...
        BADGERS.add(HuaweiHomeBadger.class);//测试通过
//        BADGERS.add(LGHomeBadger.class);
        BADGERS.add(SamsungHomeBadger.class);
        BADGERS.add(ZukHomeBadger.class);//测试通过
    }
