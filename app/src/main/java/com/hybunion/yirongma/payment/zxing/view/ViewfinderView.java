package com.hybunion.yirongma.payment.zxing.view;/*
...
//            paint.setColor(getResources().getColor(R.color.green));
            ...
            // 左上角
            canvas.drawRect(frame.left, frame.top, frame.left + 40,
                    frame.top + 5, paint);
            canvas.drawRect(frame.left, frame.top, frame.left + 5,
                    frame.top + 40, paint);
            // 右上角
            canvas.drawRect(frame.right - 40, frame.top, frame.right,
                    frame.top + 5, paint);
            canvas.drawRect(frame.right - 5, frame.top, frame.right,
                    frame.top + 40, paint);
            // 左下角
            canvas.drawRect(frame.left, frame.bottom - 5, frame.left + 40,
                    frame.bottom, paint);
            canvas.drawRect(frame.left, frame.bottom - 40, frame.left + 5,
                    frame.bottom, paint);
            // 右下角
            canvas.drawRect(frame.right - 40, frame.bottom - 5, frame.right,
                    frame.bottom, paint);
            canvas.drawRect(frame.right - 5, frame.bottom - 40, frame.right,
                    frame.bottom, paint);
