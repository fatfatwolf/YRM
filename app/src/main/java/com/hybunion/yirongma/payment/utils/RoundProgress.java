...
//        得到所有自定义属性的数组
        ...
        ringProgressColor = typedArray.getColor(R.styleable.RoundProgress_ringProgressColor, getResources().getColor(R.color.lmf_main_color));
        ...
        textColor = typedArray.getColor(R.styleable.RoundProgress_textColor,getResources().getColor(R.color.lmf_main_color));
